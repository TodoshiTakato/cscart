<?php /* Smarty version Smarty-3.1.21, created on 2022-01-10 09:13:03
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\views\product_options\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21994605961dbce6f129ca3-98154221%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '10498214c077fa5e5092d452d595ae3ccd51f584' => 
    array (
  ...
  'nocache_hash' => '21994605961dbce6f129ca3-98154221',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61dbce6f1802c4_64232541',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61dbce6f1802c4_64232541')) {function content_61dbce6f1802c4_64232541($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\function.script.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('create_or_link_an_existing_option','new_option','add_option','new_option','add_option','name','internal_option_name_tooltip','storefront_name','status','individual','edit','view','view','storefront_name','name','status','no_data','options'));
?>
...
">
            ...
            <?php if ($_smarty_tpl->tpl_vars['is_global']->value&&$_smarty_tpl->tpl_vars['has_permissions']->value) {?>
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"product_options:bulk_edit")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"product_options:bulk_edit"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                    <?php echo $_smarty_tpl->getSubTemplate ("views/product_options/components/bulk_edit.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"product_options:bulk_edit"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
$_tmp14=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['details'] = new Smarty_variable("(".$_tmp14.")", null, 0);?>
