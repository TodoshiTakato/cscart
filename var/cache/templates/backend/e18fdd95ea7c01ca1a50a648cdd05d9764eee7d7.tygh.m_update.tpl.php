<?php /* Smarty version Smarty-3.1.21, created on 2022-01-18 16:29:26
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\views\products\m_update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:87420181261e6c0b6d6d268-38178657%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e18fdd95ea7c01ca1a50a648cdd05d9764eee7d7' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\views\\products\\m_update.tpl',
      1 => 1616559142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '87420181261e6c0b6d6d268-38178657',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61e6c0b6e785f9_16679862',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61e6c0b6e785f9_16679862')) {function content_61e6c0b6e785f9_16679862($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\block.inline_script.php';
...
__" name="override_products_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value, ENT_QUOTES, 'UTF-8');?>
                                ...
                                <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductTracking::TRACK"), ENT_QUOTES, 'UTF-8');?>
...
" disabled="disabled" /><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax']->value['tax'], ENT_QUOTES, 'UTF-8');?>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['field']->value=="timestamp") {?>
                            <div class="correct-picker-but">
                            <?php echo $_smarty_tpl->getSubTemplate ("common/calendar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('date_id'=>"field_".((string)$_smarty_tpl->tpl_vars['field']->value),'date_name'=>"override_products_data[".((string)$_smarty_tpl->tpl_vars['field']->value)."]",'date_val'=>(defined('TIME') ? constant('TIME') : null),'extra'=>" disabled=\"disabled\"",'start_year'=>$_smarty_tpl->tpl_vars['settings']->value['Company']['company_start_year']), 0);?>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['field']->value=="usergroup_ids") {?>
                            <?php if (!fn_allowed_for("ULTIMATE:FREE")) {?>
                                <?php echo $_smarty_tpl->getSubTemplate ("common/select_usergroups.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"field_".((string)$_smarty_tpl->tpl_vars['field']->value)."_",'name'=>"override_products_data[".((string)$_smarty_tpl->tpl_vars['field']->value)."]",'usergroups'=>fn_get_usergroups(array("type"=>"C","status"=>array("A","H")),(defined('DESCR_SL') ? constant('DESCR_SL') : null)),'usergroup_ids'=>'','input_extra'=>" disabled=\"disabled\"",'list_mode'=>true), 0);?>
...
:&nbsp;</td>
                        <td valign="top" class="pad nowrap">
                            <?php if ($_smarty_tpl->tpl_vars['field']->value=="price"||$_smarty_tpl->tpl_vars['field']->value=="list_price") {?>
                                <input type="text"
                                       value="<?php echo htmlspecialchars(fn_format_price($_smarty_tpl->tpl_vars['product']->value[$_smarty_tpl->tpl_vars['field']->value],$_smarty_tpl->tpl_vars['primary_currency']->value,null,false), ENT_QUOTES, 'UTF-8');?>
"
                                       class="input-medium"
                                       size="5"
...
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'UTF-8');?>
                            ...
                            <?php } elseif ($_smarty_tpl->tpl_vars['type']->value=="A") {?>
                                <input 
                                    type="text"
                                    value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value[$_smarty_tpl->tpl_vars['field']->value], ENT_QUOTES, 'UTF-8');?>
"
                                    class="input-medium"
                                    name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'UTF-8');?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['field']->value=="product_code") {?>
                                        maxlength="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFieldsLength::PRODUCT_CODE"), ENT_QUOTES, 'UTF-8');?>
"
                                    <?php }?>
                                    <?php if ($_smarty_tpl->tpl_vars['readonly_fields']->value[$_smarty_tpl->tpl_vars['product']->value['product_id']][$_smarty_tpl->tpl_vars['field']->value]) {?>
                                        readonly="readonly"
                            ...
                            <?php } elseif ($_smarty_tpl->tpl_vars['type']->value=="B") {?>
                                <input type="text"
                                       value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['product']->value[$_smarty_tpl->tpl_vars['field']->value])===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'UTF-8');?>
"
                                       class="input-medium"
                                       size="5"
                                       name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
...
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'UTF-8');?>
                                          ...
                                          <?php if ($_smarty_tpl->tpl_vars['readonly_fields']->value[$_smarty_tpl->tpl_vars['product']->value['product_id']][$_smarty_tpl->tpl_vars['field']->value]) {?>
                                              readonly="readonly"
                                          <?php }?>
                                ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value[$_smarty_tpl->tpl_vars['field']->value], ENT_QUOTES, 'UTF-8');?>
</textarea>
                            <?php } elseif ($_smarty_tpl->tpl_vars['type']->value=="S") {?>
...
?>
                                        ...
                                        <?php }?>
                                    <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v_id']->value, ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['product']->value[$_smarty_tpl->tpl_vars['field']->value]==$_smarty_tpl->tpl_vars['v_id']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option_name']->value, ENT_QUOTES, 'UTF-8');?>
</option>
                                    <?php } ?>
                                </select>
                            <?php } elseif ($_smarty_tpl->tpl_vars['type']->value=="T") {?>
...
" />
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['field']->value=="timestamp") {?>
                            <div class="correct-picker-but">
                            <?php echo $_smarty_tpl->getSubTemplate ("common/calendar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('date_id'=>"prod_date",'date_name'=>"products_data[".((string)$_smarty_tpl->tpl_vars['product']->value['product_id'])."][".((string)$_smarty_tpl->tpl_vars['field']->value)."]",'date_val'=>(($tmp = @$_smarty_tpl->tpl_vars['product']->value['timestamp'])===null||$tmp==='' ? (defined('TIME') ? constant('TIME') : null) : $tmp),'start_year'=>$_smarty_tpl->tpl_vars['settings']->value['Company']['company_start_year']), 0);?>
