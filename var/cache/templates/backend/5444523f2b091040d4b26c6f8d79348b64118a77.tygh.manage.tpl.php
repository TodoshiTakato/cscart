<?php /* Smarty version Smarty-3.1.21, created on 2022-01-04 12:14:22
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\views\pages\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:135422141961d40fee11b396-42430942%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5444523f2b091040d4b26c6f8d79348b64118a77' => 
    array (
  ...
  'nocache_hash' => '135422141961d40fee11b396-42430942',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61d40fee17d987_97647742',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61d40fee17d987_97647742')) {function content_61d40fee17d987_97647742($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\function.script.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('no_data','clone_selected','pages'));
?>
...
<?php if ($_smarty_tpl->tpl_vars['has_permission']->value) {?>
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"pages:bulk_edit")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"pages:bulk_edit"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

        <?php echo $_smarty_tpl->getSubTemplate ("views/pages/components/bulk_edit.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"pages:bulk_edit"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
