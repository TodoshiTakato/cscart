<?php /* Smarty version Smarty-3.1.21, created on 2022-01-05 16:01:01
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\views\languages\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:114481355861d5968d4d01a6-45819337%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d318b56e26434ba5eac750287f20076e48de20b' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\views\\languages\\manage.tpl',
      1 => 1616559142,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '114481355861d5968d4d01a6-45819337',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61d5968d5510a2_12671886',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61d5968d5510a2_12671886')) {function content_61d5968d5510a2_12671886($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_count')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\modifier.count.php';
...
" />
                ...
                <?php $_smarty_tpl->tpl_vars['has_permission'] = new Smarty_variable(fn_check_permissions("states","update","admin","POST"), null, 0);?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['has_permission']->value&&$_smarty_tpl->tpl_vars['is_not_only_default_lang']->value) {?>
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"languages:bulk_edit")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"languages:bulk_edit"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                        <?php echo $_smarty_tpl->getSubTemplate ("views/languages/components/bulk_edit.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"languages:bulk_edit"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                    ...
                    <thead data-ca-bulkedit-default-object="true">
                        <tr class="cm-first-sibling">
                            <th width="6%" class="left" data-th="">
                                <?php echo $_smarty_tpl->getSubTemplate ("common/check_items.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('check_statuses'=>$_smarty_tpl->tpl_vars['has_permission']->value&&$_smarty_tpl->tpl_vars['is_not_only_default_lang']->value ? $_smarty_tpl->tpl_vars['language_statuses']->value : '','is_check_disabled'=>!$_smarty_tpl->tpl_vars['is_not_only_default_lang']->value||!$_smarty_tpl->tpl_vars['has_permission']->value), 0);?>
