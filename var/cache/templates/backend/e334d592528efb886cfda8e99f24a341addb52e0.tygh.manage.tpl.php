<?php /* Smarty version Smarty-3.1.21, created on 2022-01-04 10:40:58
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\views\products\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:34334768061d3e7b5ed0ab1-96310160%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e334d592528efb886cfda8e99f24a341addb52e0' => 
    array (
  ...
  'nocache_hash' => '34334768061d3e7b5ed0ab1-96310160',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_61d3e7b6051831_91553345',
  'variables' => 
  array (
    'search' => 0,
    'config' => 0,
...
<?php if ($_valid && !is_callable('content_61d3e7b6051831_91553345')) {function content_61d3e7b6051831_91553345($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\function.script.php';
if (!is_callable('smarty_block_hook')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_to_json')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\modifier.to_json.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('position_short','name','sku','price','list_price','purchased_qty','subtotal_sum','quantity','status','name','price','list_price','purchased_qty','subtotal_sum','quantity','edit','delete','status','no_data','text_select_fields2edit_note','cancel','modify_selected','clone_selected','export_selected','global_update','bulk_product_addition','product_subscriptions','export_found_products','add_product','select_fields_to_edit','products'));
?>
