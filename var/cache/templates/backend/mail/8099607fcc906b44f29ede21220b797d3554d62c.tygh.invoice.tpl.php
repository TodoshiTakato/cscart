...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '119368817761ea77cb0db9f3-36662445',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_61ea77cb17bc32_78141101',
  'variables' => 
  array (
    'order_info' => 0,
    'status_settings' => 0,
...
<?php if ($_valid && !is_callable('content_61ea77cb17bc32_78141101')) {function content_61ea77cb17bc32_78141101($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\block.hook.php';
...
if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['f_shipp']['last']) {?>, <?php }?>
                    ...
                    <?php $_smarty_tpl->tpl_vars['tracking_numbers'] = new Smarty_variable(array(), null, 0);?>
...
?>
                        <?php if ($_smarty_tpl->tpl_vars['shipment']->value['tracking_number']) {?>
                            <?php $_smarty_tpl->createLocalArrayVariable('tracking_numbers', null, 0);
$_smarty_tpl->tpl_vars['tracking_numbers']->value[] = $_smarty_tpl->tpl_vars['shipment']->value['tracking_number'];?>
                        <?php }?>
                    <?php } ?>

                    <?php if ($_smarty_tpl->tpl_vars['tracking_numbers']->value) {?>
                        <tr valign="top">
...
:</td>
                            <td style="font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars(implode(", ",$_smarty_tpl->tpl_vars['tracking_numbers']->value), ENT_QUOTES, 'UTF-8');?>
</td>
                        </tr>
                    <?php }?>
                    <?php }?>
