<?php /* Smarty version Smarty-3.1.21, created on 2022-01-22 15:36:01
         compiled from "C:\OpenServer\domains\cscart\design\themes\responsive\mail\templates\orders\invoice.tpl" */ ?>
<?php /*%%SmartyHeaderCode:98670197061ebde11b78b82-52134766%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd0577a2683730547be307d4c7e50d476c5e0a69' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\themes\\responsive\\mail\\templates\\orders\\invoice.tpl',
      1 => 1642756077,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '98670197061ebde11b78b82-52134766',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61ebde11c36257_57784079',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61ebde11c36257_57784079')) {function content_61ebde11c36257_57784079($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('invoice_heading','invoice','credit_memo','credit_memo','order_details','invoice_title','phone1_label','phone2_label','web_site','email','order','status','date','payment_method','shipping_method','carrier','tracking_number','tracking_number','customer','phone','fax','company','url','bill_to','ship_to','product','quantity','unit_price','discount','tax','subtotal','deleted_product','sku','free','free','subtotal','including_discount','order_discount','coupon','taxes','included','tax_exempt','payment_surcharge','shipping_cost','total_cost','customer_notes'));
?>
...
:</td>
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_phone'], ENT_QUOTES, 'UTF-8');?>
</bdi></td>
                    </tr>
                    <?php }?>
...
:</td>
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_phone_2'], ENT_QUOTES, 'UTF-8');?>
</bdi></td>
                    </tr>
                    <?php }?>
...
if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['f_shipp']['last']) {?>, <?php }?>
                    ...
                    <?php $_smarty_tpl->_capture_stack[0][] = array("tracking_numbers_content", null, null); ob_start(); ?>
...
?>
                            <?php if ($_smarty_tpl->tpl_vars['shipment']->value['tracking_number']) {?>
                                <?php if ($_smarty_tpl->tpl_vars['shipment']->value['carrier_info']) {?>
                                    <div><?php echo $_smarty_tpl->__("carrier");?>
...
if ($_smarty_tpl->tpl_vars['shipment']->value['carrier_info']['tracking_url']) {?></a><?php }?>)
                                        <?php }?>
                                    </div>
                                    <?php echo $_smarty_tpl->tpl_vars['shipment']->value['carrier_info']['info'];?>

                                <?php } else { ?>
                                    <div><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipment']->value['tracking_number'], ENT_QUOTES, 'UTF-8');?>
</div>
                                <?php }?>
                                <br/ >
                            <?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                    ...
                    <?php if (Smarty::$_smarty_vars['capture']['tracking_numbers_content']) {?>
                        <tr valign="top">
...
:</td>
                            <td style="font-size: 12px; font-family: Arial;"><?php echo Smarty::$_smarty_vars['capture']['tracking_numbers_content'];?>
</td>
                        </tr>
                    <?php }?>
                    <?php }?>
...
:</span>&nbsp;<bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['phone'], ENT_QUOTES, 'UTF-8');?>
</bdi></p><?php }?>
...
:</span>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['url'], ENT_QUOTES, 'UTF-8');?>
                ...
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['profile_fields']->value['B']&&($_smarty_tpl->tpl_vars['order_info']->value['b_firstname']||$_smarty_tpl->tpl_vars['order_info']->value['b_lastname']||$_smarty_tpl->tpl_vars['order_info']->value['b_address']||$_smarty_tpl->tpl_vars['order_info']->value['b_address_2']||$_smarty_tpl->tpl_vars['order_info']->value['b_city']||$_smarty_tpl->tpl_vars['order_info']->value['b_state_descr']||$_smarty_tpl->tpl_vars['order_info']->value['b_zipcode'])) {?>
...
:</h3>
                    <?php if ($_smarty_tpl->tpl_vars['order_info']->value['firstname']&&$_smarty_tpl->tpl_vars['profields_b']->value['firstname']||$_smarty_tpl->tpl_vars['order_info']->value['lastname']&&$_smarty_tpl->tpl_vars['profields_b']->value['lastname']) {?>
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_b']->value['firstname']) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
 <?php }
if ($_smarty_tpl->tpl_vars['profields_b']->value['lastname']) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['lastname'], ENT_QUOTES, 'UTF-8');
}?>
                    </p>
                    <?php }?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_zipcode'], ENT_QUOTES, 'UTF-8');
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_phone']) {?><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_phone'], ENT_QUOTES, 'UTF-8');?>
</bdi> <?php }?>
                    </p>
                    <?php }?>
...
:</h3>
                    <?php if ($_smarty_tpl->tpl_vars['order_info']->value['firstname']&&$_smarty_tpl->tpl_vars['profields_s']->value['firstname']||$_smarty_tpl->tpl_vars['order_info']->value['lastname']&&$_smarty_tpl->tpl_vars['profields_s']->value['lastname']) {?>
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_s']->value['firstname']) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
 <?php }
if ($_smarty_tpl->tpl_vars['profields_s']->value['lastname']) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['lastname'], ENT_QUOTES, 'UTF-8');
}?>
                    </p>
                    <?php }?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_zipcode'], ENT_QUOTES, 'UTF-8');
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_phone']) {?><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_phone'], ENT_QUOTES, 'UTF-8');?>
</bdi> <?php }?>
                    </p>
                    <?php }?>
...
:</b>&nbsp;</td>
                ...
                <?php } ?>
                <?php }?>
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"orders:invoice_taxes")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"orders:invoice_taxes"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
if ($_smarty_tpl->tpl_vars['tax_data']->value['regnumber']) {?>&nbsp;(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax_data']->value['regnumber'], ENT_QUOTES, 'UTF-8');?>
                ...
                <?php }?>
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"orders:invoice_taxes"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
:&nbsp;</td>
                ...
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"orders:invoice_shipping")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"orders:invoice_shipping"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
:</b>&nbsp;</td>
                ...
                <?php }?>
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"orders:invoice_shipping"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
