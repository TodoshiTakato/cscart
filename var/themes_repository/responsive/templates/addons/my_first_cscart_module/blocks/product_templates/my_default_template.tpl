    ...
    {hook name="products:view_main_info"}
        {if $product}
            ...
            <div class="ty-product-block__left">
                ...
                {*block__my_first_cscart_module_setting*}
                <div class="ty-product-block__my_first_cscart_module_setting">
                    <div class="ty-control-group ty-my_first_cscart_module_setting-item" id="my_first_cscart_module_setting_update_{$obj_prefix}{$obj_id}">
                        <label class="ty-control-group__label" id="my_first_cscart_module_setting_{$obj_prefix}{$obj_id}">{__("my_first_cscart_module_setting")}:</label>
                        <span class="ty-control-group__item" id="my_first_cscart_module_setting_{$obj_prefix}{$obj_id}">
                            {$product.my_first_cscart_module_setting}
                            <!--my_first_cscart_module_setting_{$obj_prefix}{$obj_id}-->
