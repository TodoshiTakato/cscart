{$order_info.product_groups.0.products.1061624811.main_pair.detailed.http_image_path|fn_url}
<img src="{$order_info.product_groups.0.products.1061624811.main_pair.detailed.http_image_path|fn_url}">
{if !$oi.extra.parent}
    <tr>
